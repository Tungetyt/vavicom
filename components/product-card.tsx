...
const ProductCard: FC<ProductCardProps> = ({imageURL, children}) => {
	return (
		<WobbleCard>
			<div className='group/card aspect-square'>
				<div
					style={{backgroundImage: `url('${imageURL}')`}}
					className='cursor-pointer overflow-hidden relative card rounded-md shadow-xl m-auto h-full backgroundImage flex flex-col justify-center bg-cover bg-center'
				>
					<div
					...
					<div className='text content relative z-10'>
						<p
							className='font-normal text-xl text-gray-950 my-4 flex flex-col items-center
